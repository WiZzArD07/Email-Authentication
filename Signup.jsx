...
const Signup = () => {
  ...
  const sendOtp = async () => {
    try {
      ...
      alert(
        error.response?.data?.message || "Error OTP Nhi Gaya Hai fir se kar"
      );
    }
  };
  ...
  const verifyOtp = async () => {
    try {
      ...
      alert(
        error.response?.data?.message || "Sahi OTP daal ya Network check kar"
      );
    }
  };
